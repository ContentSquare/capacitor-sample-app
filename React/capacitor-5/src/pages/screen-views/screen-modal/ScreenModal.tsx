  ...
  return (
    <IonPage>
      ...
      <IonContent className="ion-padding">
        <p>
          Tapping the Open Modal button will present a modal. When the modal
          opens it sends a screen view, and when it's closed, this screen will
          also send a screen view.
        </p>
        ...
        >
          ...
          <IonContent className="ion-padding">
            <p>
              This is the modal screen. When it's closed, the opener screen will
              also send its screen name.
            </p>
